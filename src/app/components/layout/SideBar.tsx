...
const SideBar = () => {
    ...
    return (
        <div className="z-45 sticky top-0 flex flex-col  h-screen py-20 min-h-screen min-w-[400px] w-1/3 bg-gradient-to-r from-[#18181b] to-[#222225] ">
            ...
            <Button href="https://drive.google.com/file/d/1h6ML35e9I23Rj5-_0XfaD3t_u8jSrVsh/view?usp=sharing" newTab="1" className="px-20 pt-10 pb-20">Download Resume</Button>
        </div>
    )
}
