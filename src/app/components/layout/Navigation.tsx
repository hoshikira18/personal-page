        ...
        <div className="z-50 md:sticky fixed w-full md:top-0 bottom-0 flex justify-between md:h-screen md:min-h-screen md:w-16 md:py-20">
            ...
            <div className="flex flex-col w-full justify-between h-full bg-gradient-to-r from-[#18181b] to-[#222225]">
                <div className="sticky top-8 left-0 bg-[#222225] flex md:flex-col justify-center w-screen md:w-auto">
                    <Link href="/" onClick={() => { setPage("home") }} className={`${pathname == "/" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} w-1/4 md:w-auto transition-all block group overflow-hidden`} >
                        ...
                        <svg className="w-full h-16 p-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <Link href="/about" onClick={() => { setPage("about") }} className={`${pathname == "/about" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} w-1/4 md:w-auto transition-all block group overflow-hidden`}>
                    ...
                    <Link href="/articles" onClick={() => { setPage("articles") }} className={`${pathname == "/articles" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} w-1/4 md:w-auto transition-all block group overflow-hidden`}>
                    ...
                    <Link href="/contact" onClick={() => { setPage("contact") }} className={`${pathname == "/contact" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} w-1/4 md:w-auto transition-all block group overflow-hidden`}>
