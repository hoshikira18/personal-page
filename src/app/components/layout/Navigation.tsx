        ...
        <div className="z-45 sticky top-0 flex justify-between h-screen min-h-screen w-16 py-20 ">
            ...
            <div className="flex flex-col justify-between h-full bg-gradient-to-r from-[#18181b] to-[#222225]">
                <div className="sticky top-8 left-0 bg-[#222225]">
                    <Link href="/" onClick={() => { setPage("home") }} className={`${pathname == "/" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} transition-all block group overflow-hidden`} >
                    ...
                    <Link href="/about" onClick={() => { setPage("about") }} className={`${pathname == "/about" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} transition-all block group overflow-hidden`}>
                    ...
                    <Link href="/articles" onClick={() => { setPage("articles") }} className={`${pathname == "/articles" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} transition-all block group overflow-hidden`}>
                    ...
                    <Link href="/contact" onClick={() => { setPage("contact") }} className={`${pathname == "/contact" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} transition-all block group overflow-hidden`}>
