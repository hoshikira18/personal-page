        ...
        <div className="transition-all duration-300 z-50 md:sticky fixed w-full md:top-0 bottom-0 flex justify-between md:h-screen md:min-h-screen md:w-16 md:py-20">
            ...
            <div className="flex flex-col w-full justify-between h-full bg-gradient-to-r from-[#18181b] to-[#222225]">
                <div className="sticky top-8 left-0 bg-[#222225] flex md:flex-col justify-center w-screen md:w-auto">
                    <a href="/" onClick={() => { setPage("home") }} className={`${pathname == "/" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} w-1/4 md:w-auto transition-all flex flex-col items-center group overflow-hidden`} >
                        <div className={`${pathname == "/" ? "" : "absolute z-50 right-full px-5 h-16 bg-green-600 invisible opacity-0 transition-all duration-300 translate-x-8 group-hover:-translate-x-1 group-hover:visible group-hover:opacity-100 flex items-center justify-center"}`}><span className={`${pathname == "/" ? "hidden" : "hidden group-hover:block text-gray-300 text-base"}`}>Home</span></div>
                    ...
                    <a href="/about" onClick={() => { setPage("about") }} className={`${pathname == "/about" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} w-1/4 md:w-auto transition-all flex flex-col items-center group overflow-hidden`}>
                        <div className={`${pathname == "/about" ? "" : "absolute z-50 right-full px-5 h-16 bg-green-600 invisible opacity-0 transition-all duration-300 translate-x-8 group-hover:-translate-x-1 group-hover:visible group-hover:opacity-100 flex items-center justify-center"}`}><span className={`${pathname == "/about" ? "hidden" : "hidden group-hover:block text-gray-300 text-base"}`}>About</span></div>
                    ...
                    <a href="/articles" onClick={() => { setPage("articles") }} className={`${pathname == "/articles" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} w-1/4 md:w-auto transition-all flex flex-col items-center group overflow-hidden`}>
                        <div className={`${pathname == "/articles" ? "" : "absolute z-50 right-full px-5 h-16 bg-green-600 invisible opacity-0 transition-all duration-300 translate-x-8 group-hover:-translate-x-1 group-hover:visible group-hover:opacity-100 flex items-center justify-center"}`}><span className={`${pathname == "/articles" ? "hidden" : "hidden group-hover:block text-gray-300 text-base"}`}>Articles</span></div>
                    ...
                    <a href="/contact" onClick={() => { setPage("contact") }} className={`${pathname == "/contact" ? "bg-gradient-to-tr from-primary to-secondary" : "hover:bg-green-900"} w-1/4 md:w-auto transition-all flex flex-col items-center group overflow-hidden`}>
                        <div className={`${pathname == "/contact" ? "" : "absolute z-50 right-full px-5 h-16 bg-green-600 invisible opacity-0 transition-all duration-300 translate-x-8 group-hover:-translate-x-1 group-hover:visible group-hover:opacity-100 flex items-center justify-center"}`}><span className={`${pathname == "/contact" ? "hidden" : "hidden group-hover:block text-gray-300 text-base"}`}>Contact</span></div>
