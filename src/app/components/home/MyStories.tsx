  ...
  return (
    <Pan>
      <div className="flex items-center space-x-5">
        <div className="flex w-10 flex-col space-y-2">
        ...
        <h1 className="w-44 py-5 text-2xl font-bold text-gray-300">
          Hello, there!
        </h1>
      </div>
      ...
      <div className="flex justify-center space-x-2">
        {data.map((e) => {
          return (
            <div
              className={`${show === e.id ? "w-full" : "w-[100px]"} overflow rounded-sm bg-gradient-to-tr from-primary to-secondary duration-300 ease-out hover:-translate-y-2`}
              key={e.id}
              onMouseOver={() => {
                setShow(e.id);
              }}
